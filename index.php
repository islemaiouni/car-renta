    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        <ul class="navbar-list">
          ...
          <li>
            <a href="/ridex/mail.php" class="navbar-link" data-nav-link>About us</a>
          </li>
      ...
      <div class="header-actions">
        ...
        <a href="/Login and Signup Form with Email Verification - PHP/signup-user.php" class="btn user-btn" aria-label="Profile">
